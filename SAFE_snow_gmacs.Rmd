...
do_size_comps<-1 # turn this off when iterating on documents because it takes a long time
...
colnames(tot_likes) = c("25.1 gmacs","25.1 gmacs (tbd)")
...
```{r,echo=FALSE,warning=FALSE,message=F,fig.height=10,fig.width=8,fig.cap="\\label{predfmort}Estimated fishing mortalities for the directed and non-directed fisheries."}
 ...
 plot_dat<-dfrFMbyXFY[,c(4,3,2,1,5,6)]
